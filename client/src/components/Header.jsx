...
const Header = () => {
  ...
  return (
    <motion.div
      className='flex flex-col justify-center items-center text-center my-20 text-neutral-800 dark:text-neutral-200 transition-colors duration-300'
      initial={{ opacity: 0.2, y: 100 }}
      transition={{ duration: 1 }}
      whileInView={{ opacity: 1, y: 0 }}
      viewport={{ once: true }}
    >
      {/* Tagline Badge */}
      <motion.div
        className='text-stone-500 dark:text-stone-300 inline-flex text-center gap-2 bg-white dark:bg-neutral-800 px-6 py-1 rounded-full border border-neutral-500 dark:border-neutral-400'
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.2, duration: 0.8 }}
      >
      ...
      <motion.button
        ...
        className='sm:text-lg text-white bg-black dark:bg-white dark:text-black w-auto mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full transition-colors'
        whileHover={{ scale: 1.05 }}
        whileTap={{ scale: 0.95 }}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
